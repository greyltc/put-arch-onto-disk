...
if test -b "${TARGET}"; then
	...
	findmnt --evaluate --direction backward --list --noheadings --nofsroot --output SOURCE | { grep ${TARGET_DEV} || true; } | xargs --no-run-if-empty umount --quiet --recursive --all-targets --detach-loop
	IMG_NAME=""
